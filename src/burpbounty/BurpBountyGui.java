...
public class BurpBountyGui extends javax.swing.JPanel {
        ...
        if (f.exists() && f.isDirectory()) {
            for (File file : files) {
                try {
                    ...
                    callbacks.printError("BurpBountyGui line 1805:" + e.getMessage());
                }
            }
        }
        showProfiles("All");
    ...
    private void initComponents() {
        ...
        jLabel_ignore =new javax.swing.JLabel();
        ...
        tagui = new Tags(callbacks, tagName, jTabbedPane2);
        parent.tagui = tagui;
        ...
        jLabel_ignore.setFont(new java.awt.Font("Lucida Grande", 1, 14)); // NOI18N
        jLabel_ignore.setForeground(new java.awt.Color(255, 102, 51));
        jLabel_ignore.setText("Skip Test Parameter");
...
//        }
    ...
    private javax.swing.JLabel jLabel_ignore;
    ...
    private javax.swing.JSplitPane jPanelCus;
